...
- organizations.json - Metadata about data source organizations.
...
| iconUrl           | A link to an icon image representing this source. Recommended dimensions are 40px by 40px. If you need to include the image as part of the pull request; use the sources/icons directory.
...
A new organization can be added to the organizations.json registry file by sending a pull request.
```
  {
    "id": "ORGANIZATION_ID",
